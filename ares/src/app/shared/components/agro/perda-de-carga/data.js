...
export const TBL_EFICIENCIA = [
    {sistemaIrrigacao: 'Aspersão convencional', ef: 0.65},
    {sistemaIrrigacao: 'Gotejamento', ef: 0.75},
    {sistemaIrrigacao: 'Microaspersão', ef: 0.95}
]